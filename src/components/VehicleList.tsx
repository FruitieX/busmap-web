    ...
    ({ vehicle, distance, isSubscribed, isSelected, onCardClick, onSubscriptionToggle }, ref) => {
      ...
      return (
        <motion.div
          ...
          className={`bg-gray-50 dark:bg-gray-800 rounded-xl p-3 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 transition-all ${isSelected ? 'outline outline-2 outline-primary-500' : ''}`}
          onClick={onCardClick}
        >
        <div className="flex items-center gap-3">
          ...
          <button
            className={`group shrink-0 w-10 h-10 rounded-full flex items-center justify-center transition-colors ${
              isSubscribed
